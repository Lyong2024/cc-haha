...
- 桌面端发布版本号来源是 `web/package.json`；root `package.json` 仍保留本地开发用的 `999.0.0-local`。发布时需确保 `web/package.json`、GitHub Release tag `v0.4.3` 和 `release-notes/v0.4.3.md` 三者严格对齐。
