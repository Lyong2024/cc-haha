...
- 暂不提供在线自动更新：在拿到 Apple 签名前，请每次到 [GitHub Releases](https://github.com/NanmiCoder/__KEEP_HAHA__/releases) 手动下载新版本覆盖安装。覆盖安装不会删除本地数据（`~/.claude`、`~/.claude/haha` 及自定义便携数据目录）。
