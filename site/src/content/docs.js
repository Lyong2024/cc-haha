...
const LEGACY_ROUTES = new Map(Object.entries({
  ...
  '/web/01-quick-start': '/start/first-session',
  '/web/02-architecture': '/internals/desktop',
  '/web/03-features': '/desktop',
  '/web/04-installation': '/start/install',
  '/web/05-faq': '/start/troubleshooting',
  '/web/06-h5-access': '/web/remote',
  '/web/07-electron-migration-research': '/internals/desktop',
  '/web/08-electron-migration-tasks': '/internals/desktop',
  '/web/09-electron-migration-validation-checklist': '/internals/desktop',
  '/web/10-release-auto-update': '/internals/contributing',
  '/docs': '/start',
  '/features/computer-use': '/web/computer-use',
