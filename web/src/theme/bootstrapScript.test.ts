...
function seedStorage(stored: {
  ...
  if (stored.theme !== undefined) window.localStorage.setItem('haha-theme', stored.theme)
  if (stored.follow !== undefined) window.localStorage.setItem('haha-follow-system-theme', stored.follow)
  if (stored.lightTheme !== undefined) window.localStorage.setItem('haha-light-theme', stored.lightTheme)
  if (stored.darkTheme !== undefined) window.localStorage.setItem('haha-dark-theme', stored.darkTheme)
}
