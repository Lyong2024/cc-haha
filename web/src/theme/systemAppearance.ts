 ...
 * `web/electron/services/nativeAppearance.ts` for why.
 */
...
export const THEME_STORAGE_KEY = 'haha-theme'
export const FOLLOW_SYSTEM_THEME_STORAGE_KEY = 'haha-follow-system-theme'
export const LIGHT_THEME_STORAGE_KEY = 'haha-light-theme'
export const DARK_THEME_STORAGE_KEY = 'haha-dark-theme'
