...
import { AgentCliGateBanner } from '../components/chat/AgentCliGate'
import { ExternalAgentChat } from '../components/chat/ExternalAgentChat'
...
export function ActiveSession() {
  ...
  const activeAgentCliId = useAgentCliStore((s) => s.activeId)
  const sessionAgentCliId = session?.agentCliId || activeAgentCliId || 'claude-code'
  const isExternalAgentSession = sessionAgentCliId !== 'claude-code'
  ...
  useEffect(() => {
    if (activeTabId && !isMemberSession && !isExternalAgentSession) {
      connectToSession(activeTabId)
    }
  }, [activeTabId, isMemberSession, isExternalAgentSession, connectToSession])
        ...
        >
          ...
          {isEmpty ? (
            ...
            <>
              ...
              {isExternalAgentSession && activeTabId ? (
                <ExternalAgentChat
                  cliId={sessionAgentCliId as import('../api/agentCli').AgentCliId}
                  sessionId={activeTabId}
