...
describe('ActivitySettings', () => {
  ...
  it('renders summary metrics and a GitHub-style trailing heatmap without future days', async () => {
    ...
    expect(screen.getByAltText('haha avatar')).toHaveAttribute('src', '/app-icon.png')
    expect(screen.getByAltText('haha avatar')).toHaveClass('scale-[1.28]')
    expect(screen.getByRole('link', { name: 'github.com/NanmiCoder/__KEEP_HAHA__' })).toHaveAttribute(
      'href',
      'https://github.com/NanmiCoder/__KEEP_HAHA__',
    )
