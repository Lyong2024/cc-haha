...
import { AgentCliManagerPanel } from '@/components/settings/AgentCliManagerPanel'
...
export function SystemSettings() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
      <SettingsPageHeader
        title="系统管理"
        description="管理员会话、Agent CLI 管理、在线用户（Web + IM，只读不踢人）与 IM 进程宿主。"
        action={(
