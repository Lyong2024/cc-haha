...
import { AgentCliGateBanner, useAgentCliChatAllowed } from '../components/chat/AgentCliGate'
...
export function EmptySession() {
  ...
  const { allowed: agentCliAllowed } = useAgentCliChatAllowed()
  const canSubmit = (
    input.trim().length > 0 ||
    attachments.length > 0 ||
    !!workDir
  ) && !isSubmitting && repositoryLaunchReady && agentCliAllowed
