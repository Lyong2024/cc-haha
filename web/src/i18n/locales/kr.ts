...
9번째 줄 8칸 전부: 앞 줄에 이어 정면 아래에서 왼쪽으로 돌아 왼쪽 아래, 왼쪽, 왼쪽 위를 지나 정면 위 직전까지`,
  ...
  'settings.pets.folderDescription': '사용자 지정 펫 패키지는 여기에 저장됩니다: ${CLAUDE_CONFIG_DIR:-~/.claude}/haha/pets',
  ...
  'settings.diagnostics.doctorSafeKeys': '재설정 시 다음 항목만 제거합니다: haha-open-tabs, haha-session-runtime, haha-theme, haha-locale, haha-app-zoom, haha-ui-zoom, haha.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/haha/settings.json — 직접 편집할 수 있습니다. 저장 시 기록됩니다.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'haha 데이터용 폴더 선택',
  ...
  'settings.general.traceHintOn': '새 세션은 간결한 요청, 응답, 상태 이벤트를 로컬 haha traces 디렉터리에 기록합니다.',
