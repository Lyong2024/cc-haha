...
9 行目 8 マスすべて：前の行に続き、真下から左へ回り、左下・左・左上を通って真上の手前まで`,
  ...
  'settings.pets.folderDescription': 'カスタムペットパッケージの保存先：${CLAUDE_CONFIG_DIR:-~/.claude}/haha/pets',
  ...
  'settings.diagnostics.doctorSafeKeys': 'リセットで削除されるのは次のみ: haha-open-tabs、haha-session-runtime、haha-theme、haha-locale、haha-app-zoom、haha-ui-zoom、haha.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/haha/settings.json — 直接編集できます。保存時に書き込まれます。',
  ...
  'settings.general.storagePortableDirPlaceholder': 'haha データ用のフォルダを選択',
  ...
  'settings.general.traceHintOn': '新しいセッションは、簡潔な要求、応答、状態イベントをローカルの haha traces ディレクトリに書き込みます。',
