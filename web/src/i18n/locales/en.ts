...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.pets.folderDescription': 'Custom pet packages are stored here: ${CLAUDE_CONFIG_DIR:-~/.claude}/haha/pets',
  ...
  'settings.activity.defaultHandle': 'github.com/NanmiCoder/__KEEP_HAHA__',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Reset removes only: haha-open-tabs, haha-session-runtime, haha-theme, haha-locale, haha-app-zoom, haha-ui-zoom, and haha.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/haha/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for haha data',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local haha traces directory.',
