...
第 9 列 全 8 格：接著上一列，從正下方繼續向左轉，經過左下、左邊、左上，轉回接近正上方`,
  ...
  'settings.pets.folderDescription': '自訂寵物套件儲存在這裡：${CLAUDE_CONFIG_DIR:-~/.claude}/haha/pets',
  ...
  'settings.diagnostics.doctorSafeKeys': '重設只會移除：haha-open-tabs、haha-session-runtime、haha-theme、haha-locale、haha-app-zoom、haha-ui-zoom 和 haha.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/haha/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 haha 資料的資料夾',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 haha traces 目錄。',
