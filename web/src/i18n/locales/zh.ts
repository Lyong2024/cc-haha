...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  'settings.pets.folderDescription': '自定义宠物包存储在这里：${CLAUDE_CONFIG_DIR:-~/.claude}/haha/pets',
  ...
  'settings.diagnostics.doctorSafeKeys': '重置只会移除：haha-open-tabs、haha-session-runtime、haha-theme、haha-locale、haha-app-zoom、haha-ui-zoom 和 haha.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/haha/settings.json — 直接编辑，保存时写入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 haha 数据的文件夹',
  ...
  'settings.general.traceHintOn': '新会话会把精简请求、响应、状态事件写入本机 haha traces 目录。',
