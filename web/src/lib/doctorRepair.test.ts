...
describe('doctorRepair', () => {
  ...
  it('clears only the safe desktop UI storage keys', () => {
    ...
    window.localStorage.setItem('haha-chat-history', 'preserve')
    window.localStorage.setItem('haha-provider-config', 'preserve')
    ...
    expect(window.localStorage.getItem('haha-chat-history')).toBe('preserve')
    expect(window.localStorage.getItem('haha-provider-config')).toBe('preserve')
  })
