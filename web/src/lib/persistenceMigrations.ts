...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'haha.persistence.schemaVersion'
...
const TAB_STORAGE_KEY = 'haha-open-tabs'
const SESSION_RUNTIME_STORAGE_KEY = 'haha-session-runtime'
const THEME_STORAGE_KEY = 'haha-theme'
const FOLLOW_SYSTEM_THEME_STORAGE_KEY = 'haha-follow-system-theme'
const LIGHT_THEME_STORAGE_KEY = 'haha-light-theme'
const DARK_THEME_STORAGE_KEY = 'haha-dark-theme'
const LOCALE_STORAGE_KEY = 'haha-locale'
