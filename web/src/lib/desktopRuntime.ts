...
export const H5_SERVER_URL_STORAGE_KEY = 'haha-h5-server-url'
export const H5_TOKEN_STORAGE_KEY = 'haha-h5-token'
...
/** Resolve once the web/browser server URL is initialized and healthy. */
